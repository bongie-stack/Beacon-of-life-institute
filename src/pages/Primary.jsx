...
import { BookOpen, Trophy, Palette, ArrowRight, GraduationCap, Users, Clock } from 'lucide-react';
        ...
        <div className="primary-page falcon-style">
            ...
            <div className="falcon-hero" style={{ backgroundImage: `url(${heroScience})` }}>
                ...
                <div className="container hero-content">
                    <span className="hero-tag">Excellence in Education</span>
                    <h1>Nurturing <span className="text-secondary">Future Leaders</span></h1>
                    <p className="hero-lead">A holistic approach to 21st-century learning, grounded in values and driven by innovation.</p>
